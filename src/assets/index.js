...
export const sticky_links = [
  ...
  export const RedditIcon = ({ className = "", size = 18 }) => (
  <svg
...
export const socialLinks = [
  {
    id: 1,
    name: "Facebook",
    url: "https://www.facebook.com/people/Foodmeet-Conference/61574198677476/",
    icon: <Facebook size={18} />,
  },
  {
    id: 2,
    name: "Twitter (X)",
    url: "https://x.com/foodmeet2025",
    icon: <Twitter size={18} />,
  },
  {
    id: 3,
    name: "Instagram",
    url: "https://www.instagram.com/foodmeet2025/",
    icon: <Instagram size={18} />,
  },
  {
    id: 4,
    name: "YouTube",
    url: "https://www.youtube.com/@Foodmeet2025",
    icon: <Youtube size={18} />,
  },
  {
    id: 6,
    name: "LinkedIn",
    url: "https://www.linkedin.com/company/foodmeet-conferences/",
    icon: <Linkedin size={18} />,
  },
  {
    id: 7,
    name: "Reddit",
    url: "https://www.reddit.com/user/Foodmeetconferences/",
    icon: <RedditIcon size={18}/>, // closest match
  },
];
