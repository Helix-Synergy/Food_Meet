...
export const in_about_orators_data = [
  ...
  },
 {
    id: "zacharoula",
    image: zacharoula,
    name: "Prof. Zacharoula Andreopoulou",
    about: "Prof.",
    from: "Greece",
    link: "/orator/ana",
  }, 
...
export const orators_data = [
 {
  ...
  },
  {
    id: "marly",
    image: marly,
    name: "Prof. Marly Therese Pereira",
    about: "Prof.",
    from: "Brazil",
    link: "/orator/marly",
  },
  ...
  },
  {
    id: "francesco",
    image: francesco,
    name: "Dr. Francesco Branca",
    about: "Prof",
    link: "/orator/francesco",
  },
];


export const craig_data = {
  image: craig,
  from: "United States",
  name: "Craig Watters",
  banner: craig_banner,
...
export const shlomo_data = {
  image: shlomo,
  from: "Israel",
  name: "Prof. Shlomo Nir",
  banner: shlomo_banner,
  about:
...
export const annette_data = {
  image: annette,
  from: "Germany",
  name: "Dr. Annette Rudolph",
  banner: annette_banner,
  about:
...
export const francesco_data = {
  image: francesco,
  from: "Italy",
  name: "Dr. Francesco Branca",
  banner: francesco_banner,
  about:
