...
import { ana_data, andreopoulou_data, annette_data, craig_data, francesco_data, marly_data, shlomo_data } from "../../assets/orators";
...
const OratorsTemplate = () => {
  const { id } = useParams();
  const item = oratorMap[id];
...
export default OratorsTemplate;
